...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mimicoin24-project/mimicoin24>";
    const std::string URL_WEBSITE = "<https://mimicoin24.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Mimicoin24 version %s\n", FormatFullVersion());
}
