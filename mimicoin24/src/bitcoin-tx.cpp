...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mimicoin24-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mimicoin24-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mimicoin24 transaction") + "\n" +
              "  mimicoin24-tx [options] -create [commands]   " + _("Create hex-encoded mimicoin24 transaction") + "\n" +
              "\n";
