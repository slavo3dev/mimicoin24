...
{
    const char* pszTimestamp = "Mimi The Cat - On This Day, May 15, 20201, Mimi Will try to influence and educate people to better care for domestic and big cats.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1621126317, 2000001059, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa5ba20c1996645e9f32903c0ccee80d3720124f59a159a48550040aff6169b3e "));
        assert(genesis.hashMerkleRoot == uint256S("0x76eae14b0497db3c9dfa8987751a34a7225b9649f93ec56b14cfe84f2d55f4be"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xa5ba20c1996645e9f32903c0ccee80d3720124f59a159a48550040aff6169b3e"))
        ...
        chainTxData = ChainTxData{
            ...
            1621126317, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1621126317, 447466, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa5ba20c1996645e9f32903c0ccee80d3720124f59a159a48550040aff6169b3e "));
        assert(genesis.hashMerkleRoot == uint256S("0x76eae14b0497db3c9dfa8987751a34a7225b9649f93ec56b14cfe84f2d55f4be"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x7768dbb2f0c476a545e9523d4c7a825f56aefd25e8b6cc954a2599b5ded58221")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1621126317, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3010ed85378208360ce8257872cb41aec77c23886f2218b467f125ba46ad5184"));
        assert(genesis.hashMerkleRoot == uint256S("0x76eae14b0497db3c9dfa8987751a34a7225b9649f93ec56b14cfe84f2d55f4be"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x3010ed85378208360ce8257872cb41aec77c23886f2218b467f125ba46ad5184"))
        };
