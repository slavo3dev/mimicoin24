...
const char * const BITCOIN_CONF_FILENAME = "mimicoin24.conf";
const char * const BITCOIN_PID_FILENAME = "mimicoin24.pid";
...
#else
    const char* pszModule = "mimicoin24";
#endif
    if (pex)
        return strprintf(
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Mimicoin24";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Mimicoin24";
#else
    // Unix
    return pathRet / ".mimicoin24";
#endif
#endif
}
